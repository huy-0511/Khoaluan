            ...
            <div class="panel-body">
                ...
                <form role="form" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tentintuc" class="form-control" id="exampleInputEmail1" placeholder="Tên sản phẩm" value="{{ old('tentintuc') }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="motatintuc" placeholder="Mô tả">{{ old('motatintuc') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="noidungtintuc" placeholder="Nội dung">{{ old('noidungtintuc') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="hinhanhtintuc" class="form-control" id="exampleInputEmail1" >
                         @if($errors->first('hinhanhtintuc'))
                            <span class="text-danger">{{ $errors->first('hinhanhtintuc') }}</span>
                        @endif
                    </div>
